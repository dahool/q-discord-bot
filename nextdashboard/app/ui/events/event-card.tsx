...
export default function EventCard({ event }: { event: EventSchedule }) {
  return (
      <div className="p-2 w-full">
        <div className="border-t border-gray-200">
          <div className="grid grid-cols-[15%_70%_10%] gap-1 border-gray-300 mb-2 p-2">
            ...
            <div className="text-right"><EditEvent serverId={event.guild} id={event.id} event={event} editable={(event.src == undefined)} /></div>
