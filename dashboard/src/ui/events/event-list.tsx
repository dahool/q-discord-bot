...
import type { EventSchedule, Server } from "../../models";
import { useGetEventsQuery } from "../../lib/server/query";
import { GROUP_DATE_FORMAT } from "../../dateformat";
          ...
          return (
            <div className="grid grid-rows bg-gray-50 border border-gray-100 rounded-2xl card-color mb-2" key={index}>
              <div className="m-2 flex justify-center">
                <span className="event_date">{date.toLocaleString(GROUP_DATE_FORMAT)}</span>
              </div>
